class PhoneNumbersController < ApplicationController
  ...
  def validate_number
    PhoneNumber.validate_number(user: current_user, phone_number: params[:phone_number])
  end
  ...
  private
    ...
    def phone_number_params
      params.require(:phone_number).permit(:user_id, :phone_type, :number, :validated, :code)
    end
end
